import { Grid, Typography,
  ...
  TableHead, TableCell,
  TableRow,TableBody, List,
  Select, MenuItem,
   Button, ListItem,Card } from '@mui/material'
...
function CartScreen() {
  ...
  return (
    <Layout title="Shopping Cart"><Typography component="h1" variant='h1'>
    Shopping cart
    </Typography>
    {
             ...
             {cartItems.map(item => (
               <TableRow>
                <TableCell>
                  ...
                  <Link> <Image src={item.image} alt={item.name} width={50} height={50}/> </Link>
                  </NextLink>
                </TableCell>
                <TableCell>
                <NextLink href={`/product/${item.slug}`} passHref>
